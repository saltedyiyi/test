...
<body>
	...
	<div class="search_bar clearfix">
		<div class="sub_page_name fl">我的求购</div>
	...
	<div class="main_con clearfix">
		<div class="left_menu_con clearfix">
			...
			<ul>
				...
				<li><a href="user_center_site.jsp" class="active">· 我发布的求购</a></li>
			</ul>
		</div>
		<div class="right_content clearfix">
			<h3 class="common_title2">我的求购</h3>
			<div id="myorder">
	...
	<script>
		...
		$(document).ready(function() {
			...
			table.render({
				id : 'tb',
				url : '${base}/qiugou/selectByUser.do',
				elem : '#tb',
				method : 'post',
				cellMinWidth : 150,
				where : {},
