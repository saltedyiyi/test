...
<body>
	...
	<script>
		$.ajax({
			url : '${pageContext.request.contextPath}/qiugou/selectAll.do',
			dataType : 'json',
			type : 'get',
		...
		function showData(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				html += '<li>'
						+ '<a href="detail2.jsp?id='
						+ data[i].id
						+ '"><img src="'+path+'" style="object-fit:cover;"></a>'
						+ '<h4><a href="detail2.jsp?id='
						+ data[i].id + '"> ' + data[i].name + '</a></h4>'
						+ '<div class="operate">' + '	<span class="prize">求购人:'
						+ data[i].uname + '</span>' + '</div>' + '	</li>';
