...
<body>
	<div class="header_con">
		<div class="header">
			<div class="welcome fl">欢迎来到校园二手交易平台!</div>
			<div class="fr">
				...
				<div class="user_link fl">
					...
					<a href="yonghu/cart.jsp">我的购物车</a> <span>|</span> <a
						href="yonghu/user_center_order.jsp">我的订单</a> <span>|</span> <a
						href="yonghu/user_center_order.jsp">我的求购</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="search_bar clearfix">
		...
		<div class="guest_cart fr">
			<a href="yonghu/cart.jsp" class="cart_name fl">我的购物车</a>
		</div>
	</div>

	<div class="navbar_con">
		<div class="navbar">
			<a href="yonghu/addGoods.jsp"><h1 class="fl">发布闲置</h1></a>
			<a href="yonghu/addQiuGou.jsp"><h1 class="fl" style="margin-left: 20px;">发布求购</h1></a>
		</div>
	</div>
	...
	<div class="list_model">
		<div class="list_title clearfix">
			<h3 class="fl" id="model01">二手物品</h3>
			<a href="yonghu/listGoods.jsp" class="goods_more fr" id="fruit_more">查看更多 ></a>
		</div>
	...
	<div class="list_model">
		<div class="list_title clearfix">
			<h3 class="fl" id="model02">求购物品</h3>
			<a href="yonghu/listQiuGou.jsp" class="goods_more fr">查看更多 ></a>
		</div>

		<div class="goods_con clearfix">
			<ul class="goods_list fl" id="qgwp">
	...
	<script type="text/javascript">
		...
		oFruit.onclick = function() {
			window.location.href = 'yonghu/list.jsp';
		}
		
		$.ajax({
			url : '${pageContext.request.contextPath}/goods/selectFour.do',
			dataType : 'json',
			type : 'get',
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/qiugou/selectFour.do',
			dataType : 'json',
			type : 'get',
			success : function(res) {
				var data = res.data;
		...
		function showData2(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				html+='<li>'
					...
					+ '<a href="${pageContext.request.contextPath}/jsp/yonghu/detail.jsp?id='+data[i].id+'">'
					+'<p style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">'+data[i].name+'</p></a>'
					+ '</h4> <a href="${pageContext.request.contextPath}/jsp/yonghu/detail2.jsp?id='+data[i].id+'"><img src="'+path+'"></a>'
					+ '</li>';
			}
