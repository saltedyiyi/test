...
import com.typhoon.service.CommentService;
...
public class CommentController {
	...
	@RequestMapping(value = "/selectByGid.do")
	@ResponseBody
	public Map<String, Object> selectByGid(int gid) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			map.put("code", 0);
			map.put("msg", "success");
			map.put("data", service.selectByGid(gid));
			return map;
		} catch (Exception e) {
			e.printStackTrace();
			map.put("code", 1);
	...
	public Map<String, Object> getById( int id) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			Comment bean = service.selectById(id);
			map.put("code", 0);
			map.put("msg", "success");
			map.put("data", bean);
			return map;
	...
	@ResponseBody
	public Map<String, Object> add(Comment bean,HttpServletRequest request) {
	...
	@ResponseBody
	public Map<String, Object> update(Comment bean) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
